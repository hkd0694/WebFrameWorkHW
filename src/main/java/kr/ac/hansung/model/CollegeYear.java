...
public class CollegeYear {
	...
	public CollegeYear(int c_year, int c_term, String c_code, String c_subject, String c_division, int c_credit) {
		super();
		this.c_year = c_year;
		this.c_term = c_term;
		this.c_code = c_code;
	...
	public String toString() {
		return "CollegeYear [c_year=" + c_year + ", c_term=" + c_term + ", c_code=" + c_code + ", c_subject="
				+ c_subject + ", c_division=" + c_division + ", c_credit=" + c_credit + "]";
	}
